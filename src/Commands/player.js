...
class PlayerCommand extends Command {
    ...
    async run(message, args) {
        try {
            ...
            var attachment = new Discord.Attachment(canvas.toBuffer(), args[0] + '-krunky.png');
     ...
     * @param {int} rowIndex - The row number of the statistic, indicating how far down it will be printed in the canvas
     */
