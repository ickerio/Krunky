...
class AboutCommand extends Command {
    ...
    async run(message) {
        ...
        const embed = new RichEmbed()
            ...
            // Main Info
            .setDescription(`${this.client.shard ? `Shard ${this.client.shard.id + 1}/${this.client.shard.count}` : 'This bot'} has been running for ${date.getUTCDate()-1 !== 0 ? `${date.getUTCDate()-1} days ` : ''}${date.getUTCHours()} hours ${date.getUTCMinutes()} minutes, serving ${this.client.guilds.size} servers and ${this.client.users.size} users`)
            ...
            .addField('Developer', '<@507173409159905280>, <@224452565608300544>');
