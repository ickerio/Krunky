const { RichEmbed } = require('./node_modules/discord.js.js');
...
class aboutCommand extends Command {
    ...
    async run (message) {
        ...
        const embed = new RichEmbed()
            .setAuthor('Krunky Bot', this.client.user.displayAvatarURL, 'https://krunker.io')
            ...
            .addField('Invite Link', `[Click Here](https://discordapp.com/oauth2/authorize?client_id=${this.client.id}&scope=bot&permissions=281600)`, true)
